...
Canonical merge readiness is HOLD until Final Assurance Recovery dispositions all 374 frozen applicable assurance cells under the binding convergence rule with zero expectation delta, zero unhandled exceptions, exact-base committed-candidate qualification, process CAPA/document reconciliation, and zero unresolved material findings. Ruleset activation and merge remain separately authorized actions.
